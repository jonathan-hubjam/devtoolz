...
import { Copy, Trash2, FileJson, FileCode, AlertCircle, CheckCircle2, ArrowRightLeft, ArrowRight, ShieldCheck, Hash, Clock, Link2, Fingerprint, Clipboard, Search, KeyRound } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b py-5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight mb-1">JSON ↔ YAML Converter</h1>
