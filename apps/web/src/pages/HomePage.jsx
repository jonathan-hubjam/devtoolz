...
import { ArrowRight, Code2, ShieldCheck, Zap, Lock, CheckCircle2, FileJson, Hash, Clock, Link2, Fingerprint, FileCode, Search, KeyRound, GitCompare, CaseSensitive, CalendarClock, Database, Table2, Binary, Palette } from 'lucide-react';
      ...
      <section id="available-tools" className="pt-10 pb-16 md:pt-16 md:pb-24 bg-background">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="flex flex-col h-full shadow-md hover:shadow-lg transition-all duration-300 border-border/60 hover:border-sky-500/30 group">
              <CardHeader>
                <div className="w-12 h-12 rounded-xl bg-sky-500/10 text-sky-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <CaseSensitive className="w-6 h-6" />
                </div>
                <CardTitle className="text-xl">Case Converter</CardTitle>
                <CardDescription className="text-sm mt-2">
                  Convert text to lowercase, UPPERCASE, camelCase, snake_case, kebab-case, and more — all at once.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="flex flex-col h-full shadow-md hover:shadow-lg transition-all duration-300 border-border/60 hover:border-fuchsia-500/30 group">
              <CardHeader>
                <div className="w-12 h-12 rounded-xl bg-fuchsia-500/10 text-fuchsia-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <Database className="w-6 h-6" />
                </div>
                <CardTitle className="text-xl">SQL Formatter</CardTitle>
                <CardDescription className="text-sm mt-2">
                  Format and minify SQL queries. Supports MySQL, PostgreSQL, SQLite, T-SQL, PL/SQL, and BigQuery.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="flex flex-col h-full shadow-md hover:shadow-lg transition-all duration-300 border-border/60 hover:border-emerald-500/30 group">
              <CardHeader>
                ...
                <CardTitle className="text-xl">CSV ↔ JSON</CardTitle>
                <CardDescription className="text-sm mt-2">
                  Convert CSV to JSON or JSON to CSV. Handles quoted fields, custom delimiters, and header rows.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="flex flex-col h-full shadow-md hover:shadow-lg transition-all duration-300 border-border/60 hover:border-yellow-500/30 group">
              <CardHeader>
                <div className="w-12 h-12 rounded-xl bg-yellow-500/10 text-yellow-500 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <CalendarClock className="w-6 h-6" />
                </div>
                <CardTitle className="text-xl">Cron Parser</CardTitle>
                <CardDescription className="text-sm mt-2">
                  Parse cron expressions into plain English. See a human-readable description and the next 8 scheduled run times.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <Card className="flex flex-col h-full shadow-md hover:shadow-lg transition-all duration-300 border-border/60 hover:border-violet-500/30 group">
              <CardHeader>
                ...
                <CardDescription className="text-sm mt-2">
                  Convert colors between HEX, RGB, HSL, HSV, and CMYK with a live preview and visual color picker.
                </CardDescription>
              </CardHeader>
              <CardContent className="flex-grow">
                <ul className="space-y-2 text-sm text-muted-foreground">
